    ...
    <div className="min-h-screen flex flex-col font-sans bg-white relative overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 w-full py-3 px-6 md:px-12 lg:px-20 flex justify-between items-center z-[100] bg-white/80 lg:bg-white/20 lg:backdrop-blur-xl border-b border-gray-100/50 shadow-sm transition-all duration-300">
        ...
        <div className="flex items-center gap-3 group cursor-pointer">
          <div className="w-10 h-10 bg-primary rounded-xl text-white flex items-center justify-center font-bold text-2xl leading-none shadow-lg shadow-primary/20 group-hover:rotate-12 transition-transform duration-300">
            +
          </div>
          <span className="font-bold text-navy tracking-tight text-2xl">Adcock</span>
        </div>
          ...
          <div className={`absolute top-0 right-0 h-full w-[85%] max-w-[380px] bg-white shadow-2xl transition-transform duration-500 cubic-bezier(0.16, 1, 0.3, 1) transform ${isMenuOpen ? "translate-x-0" : "translate-x-full"} z-[2001] flex flex-col`}>
            <div className="p-8 flex justify-between items-center border-b border-gray-50">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-primary rounded-lg text-white flex items-center justify-center font-bold text-lg">+</div>
                <span className="font-bold text-navy tracking-tight text-xl">Adcock</span>
              </div>
              <button
            ...
            <div className="p-8 border-t border-gray-50">
              ...
              <p className="text-center text-gray-400 text-sm mt-6 font-medium">© 2026 Adcock Pharmacy</p>
            </div>
          </div>
        </div>
      </nav>
                      ...
                      <div className="flip-card-inner">
                        ...
                        <div className="flip-card-back">
                          ...
                          <div className="mt-auto pt-4 border-t border-white/20 w-full text-[10px] uppercase font-bold tracking-widest opacity-70 flex justify-between items-center">
                            <span>Adcock Pharmaceutical</span>
                    ...
                    {activeCommitment === 3 ? (
                      <div className="w-full h-full relative flex items-center justify-center overflow-hidden">
                        ...
                        <div className="group/card relative w-full aspect-square max-w-[500px] rounded-[40px] overflow-hidden transition-all duration-700 hover:scale-105">
                          ...
                          <a href="mailto:info@adcock.com" className="absolute bottom-1/2 right-1/2 translate-x-1/2 translate-y-1/2 transition-all duration-700 group-hover/card:bottom-12 group-hover/card:right-12 group-hover/card:translate-x-0 group-hover/card:translate-y-0 z-30">
      ...
      <section id="about-us" className="w-full bg-white py-32 px-8 md:px-12 lg:px-20 relative z-10 overflow-hidden">
        <div className="max-w-[1200px] mx-auto">
          {(() => {
            const timelineItems = [
              { year: "2010", title: "The Foundation", desc: "Adcock Pharmacy was established with a vision to revolutionize localized pharmaceutical care.", img: image1 },
        ...
        <div className="max-w-[1400px] mx-auto px-6 relative flex flex-col items-center justify-center min-h-[500px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center pt-24 overflow-hidden pointer-events-none select-none z-0">
            <div className="animate-marquee flex whitespace-nowrap">
              <span className="text-[10vw] font-medium uppercase text-primary opacity-[0.2] mx-10 whitespace-nowrap tracking-tighter inline-block" style={{ transform: 'scaleX(0.7)' }}>Adcock &nbsp;&nbsp;&nbsp; Pharmaceutical</span>
              <span className="text-[10vw] font-medium uppercase text-primary opacity-[0.2] mx-10 whitespace-nowrap tracking-tighter inline-block" style={{ transform: 'scaleX(0.7)' }}>Adcock &nbsp;&nbsp;&nbsp; Pharmaceutical</span>
              <span className="text-[10vw] font-medium uppercase text-primary opacity-[0.2] mx-10 whitespace-nowrap tracking-tighter inline-block" style={{ transform: 'scaleX(0.7)' }}>Adcock &nbsp;&nbsp;&nbsp; Pharmaceutical</span>
            </div>
          </div>
              ...
              return (
                ...
                >
                  <div className="showcase-card-custom group">
                    ...
                    <p className="card-brand-name">Adcock Pharma</p>
                  </div>
                </div>
              );
            })}
      ...
      <footer className="relative bg-[#0a0a0a] text-white pt-24 pb-12 overflow-hidden border-t border-white/5">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[25vw] font-black text-white/[0.02] pointer-events-none select-none z-0 tracking-tighter">
          ADCOK
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
            ...
            <Reveal animation="reveal-up">
              <div className="flex flex-col gap-8">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-primary rounded-xl text-white flex items-center justify-center font-bold text-2xl leading-none shadow-lg shadow-primary/20">
                    +
                  </div>
                  <span className="font-bold text-white tracking-tight text-2xl uppercase">Adcock</span>
                </div>
                ...
                <div className="flex gap-4">
                  <a href="https://www.facebook.com/Adcokpharmaceutical" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-primary hover:border-primary transition-all duration-300 group">
                    <svg className="w-6 h-6 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                  </a>
                  <a href="https://api.whatsapp.com/send?phone=923066966385&text=ADCOK+pharmaceuticals" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-primary hover:border-primary transition-all duration-300 group">
